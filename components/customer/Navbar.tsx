...
import { Search, MapPin, ChevronDown, Menu, X, Ticket, Bell, User } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="max-w-screen-xl mx-auto px-4 h-14 flex items-center gap-3">
        ...
        {/* Logo */}
        <Link href="/" id="nav-logo" className="flex items-center gap-2 mr-1 shrink-0 group">
        ...
        <div className="relative shrink-0">
          ...
          >
            ...
            <ChevronDown className={cn("w-3.5 h-3.5 transition-transform duration-200", cityOpen && "rotate-180")} />
          </button>
      ...
      {mobileOpen && (
        <div className="sm:hidden bg-[#0D1526] border-t border-white/[0.06] px-4 py-4 space-y-1">
          ...
          <div className="pt-3 border-t border-white/[0.06]">
            <Link href="/auth/login" className="block text-center py-2.5 rounded-lg gradient-brand text-white text-sm font-semibold">
              Sign In
            </Link>
          </div>
        </div>
